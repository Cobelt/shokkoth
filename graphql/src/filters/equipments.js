...
export const withCharacters = {
  name: 'withCharacters',
  type: 'Boolean',
  query: (query, value) => set(query, 'characters.0', { $exists: value }),
};
...
export const levelMin = {
  name: 'levelMin',
  type: 'Float',
  query: (query, value) => set(query, 'level.$gte', value),
};

export const levelMax = {
  name: 'levelMax',
  type: 'Float',
  query: (query, value) => set(query, 'level.$lte', value),
};

export const typeIn = {
  name: 'typeIn',
  type: '[EnumEquipmentsType]',
  query: (query, value) => set(query, 'type.$in', value),
};
...
export const searchName = {
  name: 'searchName',
  type: 'String',
  query: (query, value) => (value.length >= 2) ? set(query, 'name', new RegExp(value, 'i')) : query,
};
