...
app.use(cors({
  origin: function(origin, callback){
    ...
    if (origin && !ALLOWED_ORIGINS.includes(origin.replace(/http(?:s?):\/\//, '').replace(/:\d+$/, ''))){
...
app.listen(port, hostname, () => console.log(`Shokkoth's GraphQL started on http://${hostname}:${port}`))
