...
export const getStatSrcImg = memoize((label) => {
  ...
  return srcImg ? `//img.shokkoth.tk/assets/stats/${srcImg}` : null;
})
...
export const getWeaponCharac = memoize((label) => {
  ...
  if (found) {
    ...
    charac = value;
    charac.imgUrl = `//img.shokkoth.tk/assets/stats/${value.imgUrl}`;
  }
...
export const getDefaultPassiveImg = memoize(() => '//img.shokkoth.tk/assets/stats/passif.png')
