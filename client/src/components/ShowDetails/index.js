...
const ShowDetails = ({ equipment, selectEquipment, equip, ...otherProps }) => {
  ...
  return (
    <Element className={['show-details', display === DETAIL_EQUIPMENT ? 'equipments-details' : 'set-details', 'align-start', 'bg-primary', 'position-relative', 'pad-1-rem', equipment ? 'show' : 'hide'].filter(e => !!e).join(' ').trim()} {...otherProps}>
